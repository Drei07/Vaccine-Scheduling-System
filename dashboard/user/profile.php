...
$UId 						= $student['userId'];
$first_name                 = $student["userFirst_Name"];
$middle_name                = $student["userMiddle_Name"];
$last_name                  = $student["userLast_Name"];
$sex                        = $student["userSex"];
$birth_date                 = $student["userBirthDate"];
$age                        = $student["userAge"];
$civil_status               = $student["userCivilStatus"];
$religion                   = $student["userReligion"];
$phone_number               = $student["userPhone_Number"];
$email                      = $student["userEmail"];
$province                   = $student["userProvince"];
$city                       = $student["userCity"];
$barangay                   = $student["userBarangay"];
$street                   	= $student["userStreet"];
$profile_user					=$student["userProfile"];
