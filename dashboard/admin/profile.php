...
$admin_id       = $row['userId'];
$admin_name     = $row['health_center_name'];
	...
	<section id="content">
		...
		<nav>
			...
			<a href="profile" class="profile" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Profile">
				<img src="../../src/img/<?php echo $admin_profile ?>">
			</a>
		</nav>
		<!-- NAVBAR -->
                    ...
                    <section class="profile-form">
                        ...
                        <div class="profile">
                            <div class="profile-img">
                                ...
                                <a href="controller/delete-profile-controller.php?id=<?php echo $admin_id ?>" class="delete"><i class='bx bxs-trash'></i></a>
                            ...
                            <div id="Edit">
                            <form action="controller/update-profile-controller.php?id=<?php echo $admin_id ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" autocapitalize="on" autocomplete="off" name="Name" id="name" required value="<?php  echo $admin_name ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input disabled type="email" class="form-control" autocapitalize="off" autocomplete="off" name="Email" id="email" required value="<?php  echo $admin_email  ?>">
                                        <div class="invalid-feedback">
                            ...
                            <form action="controller/update-profile-avatar-controller.php?id=<?php echo $admin_id ?>" method="POST" enctype="multipart/form-data" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">
                                    ...
                                    <div class="col-md-12" style="opacity: 0; padding-bottom: 1.3rem;">
                                        <label for="sname" class="form-label">Old Password<span> *</span></label>
                                        <input type="text" class="form-control" autocapitalize="on" autocomplete="off" name="" id="sname">
                                        <div class="invalid-feedback">
                                        Please provide a Old Password.
                                        </div>
                                    </div>
                                ...
                                <div class="addBtn">
                                    <button type="submit" class="primary" name="btn-update-avatar" id="btn-update-avatar" onclick="return IsEmpty(); sexEmpty();">Update</button>
                                </div>
                            </form>
                            </div>

                            <div id="password" style="display: none;">
                            <form action="controller/update-password-controller.php?id=<?php echo $admin_id ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">
