				...
				<div class="order">
                    ...
                    <!-- BODY -->
                        ...
                        <div class="registration">
                            <form action="controller/add-services-controller.php" method="POST" class="row gx-5 needs-validation" enctype="multipart/form-data" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">
                                    <!-- Baby Information -->

                                    <div class="col-md-12">
                                        <label for="services" class="form-label">Services<span> *</span></label>
                                        <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control"  autocomplete="off" name="services" id="services" required>
                                        <div class="invalid-feedback">
                                        Please add a Services.
                                        </div>
                                    </div>
